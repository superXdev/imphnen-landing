...
export default function Testimonials() {
  ...
  return (
    <section id="testimoni" className="w-full py-20 md:py-32 bg-muted relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          ...
          >
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight lg:text-5xl">
              Testimoni{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">Member</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                Bergabunglah dengan{" "}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">10,000+</span>{" "}
                programmer Indonesia lainnya
              </h3>
              <p className="text-muted-foreground">
                Komunitas kami terus berkembang dengan programmer dari berbagai latar belakang dan tingkat keahlian.
                Bersama-sama, kita belajar, berbagi, dan tumbuh sebagai profesional.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="rounded-lg border p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">Mendapat Pekerjaan</div>
              </div>
              <div className="rounded-lg border p-4 text-center">
                <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">
                  24/7
